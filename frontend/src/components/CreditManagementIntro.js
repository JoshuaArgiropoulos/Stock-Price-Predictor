        ...
        !topic && (
            <div className={styles['investment-types']}>
                <div className={styles['hero-section']}>
                    <h1>Master the Art of Credit Management</h1>
                    <p>Learn how to effectively manage your credit and financial well-being.</p>
                </div>
                
                <section className={styles['intro-text']}>
                    <p>Explore the world of credit management and discover essential strategies to maintain a healthy credit score, reduce debt, and make informed financial decisions. From understanding credit reports to responsible credit card usage, we provide valuable insights to help you take control of your financial future.</p>
                </section>
